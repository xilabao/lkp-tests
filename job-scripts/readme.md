...
# job-scripts/monitor-perf contains 'perf-stat', you can choose other perf tools from lkp-tests/monitors/perf-*
# then update both monitor-perf and monitor-perf.yaml
