...
[root@localhost lkp-tests]# lkp run -s sleep job-scripts/monitor.sh --sleep 10
result_root: /lkp/result/sleep/default/localhost.localdomain/fedora/defconfig/gcc-8/5.2.0-rc3-8e44c7840479/0
2019-10-27 03:21:46
wait for background processes: 21401 21409 21405 21412 21418 slabinfo buddyinfo zoneinfo proc-vmstat meminfo

# job-scripts/monitor-perf.sh contains perf-stat,
# you can choose other perf tools from lkp-tests/monitors/perf-*
[root@localhost lkp-tests]# lkp run -s sleep job-scripts/monitor-perf.sh --sleep 10
result_root: /lkp/result/sleep/default/localhost.localdomain/fedora/defconfig/gcc-8/5.2.0-rc3-8e44c7840479/1
2019-10-27 03:22:02
...
lrwxrwxrwx 1 root root 95 Oct 27 03:22 result_root -> /lkp/result/sleep/default/localhost.localdomain/fedora/defconfig/gcc-8/5.2.0-rc3-8e44c7840479/1
[root@localhost lkp-tests]# ls /lkp/result/sleep/default/localhost.localdomain/fedora/defconfig/gcc-8/5.2.0-rc3-8e44c7840479/1
